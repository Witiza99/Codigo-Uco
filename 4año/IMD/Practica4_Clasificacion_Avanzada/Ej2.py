...
for train_file in train_files:
	...
	for train_index, test_index in skf.split(X_train, Y_train):
		...
		# Create Decision Tree classifer object
		svm_model = BaggingClassifier(base_estimator=svm.SVC(kernel='linear'), n_estimators=10, random_state=10)
		# Train Decision Tree Classifer
	...
	for train_index, test_index in skf.split(X_train, Y_train):
		...
		# Create Decision Tree classifer object
		neigh = BaggingClassifier(base_estimator=GaussianNB(), n_estimators=10, random_state=10)
		# Train Decision Tree Classifer
