...
int main(){
	...
	std::cout << "La cantidad de lanzamientos del dado 1 es " <<d.getLanzamientos1() << "\n"; //dice los lanzamientos del dado 1
	std::cout << "La cantidad de lanzamientos del dado 2 es " <<d.getLanzamientos2() << "\n"; //dice los lanzamientos del dado 2
