...
function addButton(nuevo,pagina){
	...
	var contenido = document.createTextNode("Login/Registro");
	var a_element = document.createElement("a");
	a_element.appendChild(contenido);
	var h_ref = document.createAttribute("href");
	h_ref.value = "./userLoginView.jsp";
...
function isLogin(){
	var valor = document.getElementById("botonLogin").value;
	console.log("valor vlaue-> " + valor);
	if(valor === "ok"){
		console.log("isLogin");
		return true;
	}else{
