...
<html>
	<head>
		...
		<script>
			window.history.pushState(null, '', 'http://localhost:8080/fundthescience/mvc/view/cvResume/cvResumeViewSuccess.jsp');    
		</script>
	</head>
	<body>
		<div id="cuerpo">
			...
			<div style="padding: 100px;background:white;">
				<h3>El curriculum se ha guardado con exito!!</h3>
