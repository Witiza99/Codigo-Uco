...
src/%.o: ../src/%.cpp
	...
	g++ -std=c++0x -I"/home/rafa/eclipse-workspace/P3Metaheuristics/src/include" -O0 -g3 -pedantic -pedantic-errors -Wall -Wextra -Werror -Wconversion -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
