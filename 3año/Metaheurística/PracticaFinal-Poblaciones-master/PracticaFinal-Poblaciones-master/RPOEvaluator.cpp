...
double RPOEvaluator::computeDeltaFitness(RPOInstance &instance, RPOSolution &solution, double *vec){
  double *newSol = vec;
  double *oldSol = solution.getSol();
  double actualFitness = RPOEvaluator::computeFitness(instance, solution);
  solution.setSol(newSol);
  double newFitness = RPOEvaluator::computeFitness(instance, solution);
  solution.setSol(oldSol);
