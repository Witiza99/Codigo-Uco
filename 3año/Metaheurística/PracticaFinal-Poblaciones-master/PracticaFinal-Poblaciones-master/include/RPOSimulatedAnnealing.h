 ...
 *
 * Fichero que define la clase RPOSimulatedAnnealing. Forma parte del código esqueleto para el problema de las múltiples mochilas cuadráticas, ofrecido para las prácticas de la asignatura Metaheurísticas del Grado de Ingeniería Informática de la Universidad de Córdoba
 *
...
/**
 * Clase que implementa el Enfriamiento Simulado para el RPO.
 */
...
protected:
	 ...
	 * _solution Solución al RPO sobre la que trabaja el Enfriamiento Simulado
