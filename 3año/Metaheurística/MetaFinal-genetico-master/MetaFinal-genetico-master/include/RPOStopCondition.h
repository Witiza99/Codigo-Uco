 ...
 * RPOStopCondition.h
 *
 * Fichero que define la clase RPOStopCondition. Forma parte del código esqueleto para el problema de las múltiples mochilas cuadráticas, ofrecido para las prácticas de la asignatura Metaheurísticas del Grado de Ingeniería Informática de la Universidad de Córdoba
 *
...
public:
	...
	virtual bool reached(){
		...
		double numEvaluations = RPOEvaluator::getNumEvaluations();
