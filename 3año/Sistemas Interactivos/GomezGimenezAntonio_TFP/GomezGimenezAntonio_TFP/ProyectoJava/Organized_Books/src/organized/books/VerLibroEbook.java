...
//clase para ver un Ebook
public class VerLibroEbook extends javax.swing.JPanel {
    ...
    public VerLibroEbook() {
        initComponents();
    }
    
    public VerLibroEbook(int id) {
        initComponents();
    ...
    public JButton getBoton_modificar_libroe() {
