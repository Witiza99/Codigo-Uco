...
//clase que contiene la interfaz para Modificar un libro Fisico
public class ModificarLibroFisico extends javax.swing.JPanel {
    ...
    public ModificarLibroFisico() {
        initComponents();
    }
    
    public ModificarLibroFisico(int id) {
        initComponents();
    ...
    public void ModificarLibro(){
        Libro libro_elegido = new Libro(_id, campo_nombre.getText(), campo_autor.getText(), campo_resumen.getText(), campo_lugar.getText(), comp_nota.getNota());
        Bd.ModificarLibro(_id, libro_elegido, 0);
    }
